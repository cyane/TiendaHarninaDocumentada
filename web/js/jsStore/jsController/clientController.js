(function () {
		...
		//activa las estrategias de muestra de formulario
		...
		//activa las estrategia de mostrar el formulario uno por uno al validar
		...
		//muestra el mensaje de eroor y colorea de rojo la parte referente del formulario
