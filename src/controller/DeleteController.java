...
/**
 * Cuando es llamada desde JS ejecuta una procedure que "elimina" al cliente de
 * la BBDD
 *
 */
@WebServlet("/delete")
public class DeleteController extends ClientController {
	...
	@Override
	protected boolean accion() throws IllegalAccessException, ParseException, InstantiationException, SQLException,
